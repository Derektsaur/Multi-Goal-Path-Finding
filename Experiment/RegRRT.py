...
def predict_promising_region_V2(map_route,i,img_gray, net,device):
    ...
    out2_array = out2.detach().cpu().numpy()
    ...
    promising_region_list2=exstract_promising_region(out2_array,img_gray,promising_region_list2)
...
if __name__ == '__main__':
    ...
    # map 11 case1
    # g = 110         # 11->110
    # targetCoordinate = [[100, 120], [240, 230]]  # -->[[93,175], [240, 230]]  case1
    # targetCoordinate = [[93,175], [240, 230]]
    # map 11 case 2
    g = 11 #11->111
    targetCoordinate = [[249, 130], [170, 230]]   #  [[249, 130], [170, 230]]  -->[[240,168], [170, 230]] case 2
    # map 36
    # g = 360  #36->360   #VVV   W1200
    # targedtCoordinate = [[96,84],[231,149]]  #[[96,84],[231,149]] -> [[96,84],[188,185]]
    # targetCoorinate = [[96, 84], [188, 185]]
    ...
    for testNum in range(100):
        ...
        step_size = 15 # stepsize 15 or 10 only when "map 15"
        ...
        IMG = copy.copy(map)
        # IMG2 = cv2.imread(r"C:\Users\huang\Desktop\S&Reg V2\PAPER\DRAW\BUILDING\T3851.png")   #T3851  W1200
