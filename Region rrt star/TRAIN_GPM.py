...
weight_path= r'C:\Users\huang\Desktop\Region RRTStar V2\Params\unet_64.pth'
data_path='Data'
...
if __name__ == '__main__':
    ...
    while epoch < epoch_num:
        ...
        for i, (image, segment_image1, segment_image2) in enumerate(data_loader):
            ...
            total_evaluation_criteria_temp = evaluation(out_image2, segment_image2)
            ...
            total_batch_evaluation_criteria_temp = evaluation(out_image2, segment_image2)
