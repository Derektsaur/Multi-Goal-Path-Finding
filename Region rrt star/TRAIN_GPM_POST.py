...
if __name__ == '__main__':
    ...
    ave_DICE_validate = []
    ave_Loss_validate2 = []
    ave_recall_validate2 = []
    ave_precision_validate2 = []
    ave_acc_validate2 = []
    ave_fnr_validate2 = []
    ave_F1_validate2 = []
    ave_IOU_validate2 = []
    ...
    while epoch < epoch_num:
        ...
        for i, (image, segment_image1, segment_image2) in enumerate(data_loader):
            ...
            train_loss1 = loss_fun1(out_image1, segment_image1).to(device)
            train_loss2 = loss_fun2(out_image1, segment_image1).to(device)
            train_loss3 = loss_fun1(out_image2, segment_image2).to(device)
        ...
        total_evaluation_criteria_validate2 = [0, 0, 0, 0, 0, 0, 0]
        ...
        # Criteria for evaluation
            ...
            total_evaluation_criteria_validate_temp = evaluation(out_image2, segment_image2)
            total_evaluation_criteria_validate2 = [
                total_evaluation_criteria_validate2[k] + total_evaluation_criteria_validate_temp[k] for k in
                range(len(total_evaluation_criteria_validate_temp))]
            #    evaluation_criteria = [recall, precision, acc, fnr, F1, IOU, DICE]
        ...
        ave_evaluation_criteria_validate2 = [total_evaluation_criteria_validate2[k] / (len(validate_loader)) for k in
                                            range(len(total_evaluation_criteria_validate2))]
        print(
        ...
        print(
            "[test result on validate dataset]--ave loss: {:.6f}---recall: {:.4f}%, precision: {:.4f}%, acc: {:.4f}%, fnr: {:.4f}%, F1: {:.4f}, IOU: {:.4f}, DICE: {:.4f}".format( \
                loss, 100. * ave_evaluation_criteria_validate2[0], 100. * ave_evaluation_criteria_validate2[1],
                      100. * ave_evaluation_criteria_validate2[2], 100. * ave_evaluation_criteria_validate2[3], \
                ave_evaluation_criteria_validate2[4], ave_evaluation_criteria_validate2[5],
                ave_evaluation_criteria_validate2[6]))
        ...
        ave_recall_validate2.append(ave_evaluation_criteria_validate2[0])
        ave_precision_validate2.append(ave_evaluation_criteria_validate2[1])
        ave_acc_validate2.append(ave_evaluation_criteria_validate2[2])
        ave_fnr_validate2.append(ave_evaluation_criteria_validate2[3])
        ave_F1_validate2.append(ave_evaluation_criteria_validate2[4])
        ave_IOU_validate2.append(ave_evaluation_criteria_validate2[5])
        ave_DICE_validate2.append(ave_evaluation_criteria_validate2[6])
        temp = ave_F1_validate2[-1]
    ...
    total_evaluation_criteria_test2 = [0, 0, 0, 0, 0, 0, 0]
    ...
    for l, (image, segment_image1, segment_image2) in enumerate(test_loader):
        ...
        for j in range(batch_num_test):
            ...
            save_image_tensor2pillow(predict_img2, F'TestResult/Result1/2_prediction{l}_{j}.jpg')
            save_image_tensor2pillow(true_img2, F'TestResult/Result1/2_groundtruth{l}_{j}.jpg')
        ...
        total_evaluation_criteria_test2 = [
            total_evaluation_criteria_test2[k] + total_evaluation_criteria_test_temp[k] for k in
            range(len(total_evaluation_criteria_test_temp))]
        # if l==10:
        #     break
    ...
    ave_evaluation_criteria_test2 = [total_evaluation_criteria_test2[k] / (len(test_loader)) for k in
                                    range(len(total_evaluation_criteria_test2))]
    print(
    ...
    print(
        "[test result on test 1 dataset]--ave loss: {:.6f}---recall: {:.4f}%, precision: {:.4f}%, acc: {:.4f}%, fnr: {:.4f}%, F1: {:.4f}, IOU: {:.4f}, DICE: {:.4f}".format( \
            loss, 100. * ave_evaluation_criteria_test2[0], 100. * ave_evaluation_criteria_test2[1],
                  100. * ave_evaluation_criteria_test2[2], 100. * ave_evaluation_criteria_test2[3], \
            ave_evaluation_criteria_test2[4], ave_evaluation_criteria_test2[5],
            ave_evaluation_criteria_test2[6]))
    ...
    for l, (image, segment_image1, segment_image2) in enumerate(SEENdataloader):
        ...
        for j in range(batch_num_test):
            ...
            save_image_tensor2pillow(predict_img2, F'TestResult/Result2/2_prediction{l}_{j}.jpg')
            save_image_tensor2pillow(true_img2, F'TestResult/Result2/2_groundtruth{l}_{j}.jpg')
            ...
            save_image_tensor2pillow(unit_image2, F'TestResult/Result2/2_{l}_{j}_original.jpg')
            save_image_tensor2pillow(unit_image1, F'TestResult/Result2/2_{l}_{j}.jpg')
    ...
    ave_evaluation_criteria_test = [total_evaluation_criteria_test[k] / (len(SEENdataloader)) for k in
                                    range(len(total_evaluation_criteria_test))]
    ave_evaluation_criteria_test2 = [total_evaluation_criteria_test2[k] / (len(SEENdataloader)) for k in
                                    range(len(total_evaluation_criteria_test2))]
    print(
    ...
    for l, (image, segment_image1, segment_image2) in enumerate(UNSEENdataloader):
        ...
        for j in range(batch_num_test):
            ...
            save_image_tensor2pillow(predict_img2, F'TestResult/Result3/2_prediction{l}_{j}.jpg')
            save_image_tensor2pillow(true_img2, F'TestResult/Result3/2_groundtruth{l}_{j}.jpg')
            ...
            save_image_tensor2pillow(unit_image2, F'TestResult/Result3/2_{l}_{j}_original.jpg')
            save_image_tensor2pillow(unit_image1, F'TestResult/Result3/2_{l}_{j}.jpg')
        ...
        total_evaluation_criteria_test = [total_evaluation_criteria_test[k] + total_evaluation_criteria_test_temp[k] for k in
                range(len(total_evaluation_criteria_test_temp))]
        total_evaluation_criteria_test_temp = evaluation(out_image2, segment_image2)
        total_evaluation_criteria_test2 = [total_evaluation_criteria_test2[k] + total_evaluation_criteria_test_temp[k] for k in
                range(len(total_evaluation_criteria_test_temp))]
    ...
    ave_evaluation_criteria_test = [total_evaluation_criteria_test[k] / (len(UNSEENdataloader)) for k in
                                        range(len(total_evaluation_criteria_test))]
    ave_evaluation_criteria_test2 = [total_evaluation_criteria_test2[k] / (len(UNSEENdataloader)) for k in
                                        range(len(total_evaluation_criteria_test2))]
    print(
